...
RESOURCES += src/qt/lega.qrc src/qt/lega_locale.qrc

TRANSLATIONS += src/qt/locale/lega_bg.ts \
                src/qt/locale/lega_de.ts \
                src/qt/locale/lega_en.ts \
                src/qt/locale/lega_es.ts \
                src/qt/locale/lega_fi.ts \
                src/qt/locale/lega_fr.ts \
                src/qt/locale/lega_it.ts \
                src/qt/locale/lega_ja.ts \
                src/qt/locale/lega_pl.ts \
                src/qt/locale/lega_pt.ts \
                src/qt/locale/lega_ru.ts \
                src/qt/locale/lega_sk.ts \
                src/qt/locale/lega_sv.ts \
                src/qt/locale/lega_vi.ts \
                src/qt/locale/lega_zh_CN.ts \
                src/qt/locale/lega_zh_TW.ts
