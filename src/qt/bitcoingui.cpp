                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lega Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lega: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lega Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lega Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lega"));
    ...
    openAction->setStatusTip(tr("Open a lega: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lega Core help message to get a list with possible Lega command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lega Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lega network", "", count));
}
...
{
    QString strTitle = tr("Lega Core"); // default title
