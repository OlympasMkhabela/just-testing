...
/* Lega GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Lega"
#define QAPP_ORG_DOMAIN "lega.com"
#define QAPP_APP_NAME_DEFAULT "Lega-Qt"
#define QAPP_APP_NAME_TESTNET "Lega-Qt-testnet"
