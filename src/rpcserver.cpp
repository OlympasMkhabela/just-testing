...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lega features */
        {"lega", "masternode", &masternode, true, true, false},
        {"lega", "listmasternodes", &listmasternodes, true, true, false},
        {"lega", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lega", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lega", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lega", "masternodedebug", &masternodedebug, true, true, false},
        {"lega", "startmasternode", &startmasternode, true, true, false},
        {"lega", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lega", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lega", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lega", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lega", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lega", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lega", "mnbudget", &mnbudget, true, true, false},
        {"lega", "preparebudget", &preparebudget, true, true, false},
        {"lega", "submitbudget", &submitbudget, true, true, false},
        {"lega", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lega", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lega", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lega", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lega", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lega", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lega", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lega", "checkbudgets", &checkbudgets, true, true, false},
        {"lega", "mnsync", &mnsync, true, true, false},
        {"lega", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> lega-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18095/\n";
}
