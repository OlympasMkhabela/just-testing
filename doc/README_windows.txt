...
Intro
-----
Lega (XGA) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Lega utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run lega-qt.exe.

Lega Core is the original Lega client and it builds the backbone of the network.
However, it downloads and stores the entire history of Lega transactions;
