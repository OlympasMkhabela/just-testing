...
This mechanism has been integrated into Bitcore-Node-Lega which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lega-project/insight-api-lega#web-socket-api](https://github.com/lega-project/insight-api-lega#web-socket-api)
* API: [https://github.com/lega-project/insight-api-lega#swifttx-transactions](https://github.com/lega-project/insight-api-lega#swifttx-transactions)
...
By default, the Lega Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lega Core daemon:
