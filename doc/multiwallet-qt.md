...
In order to support loading of multiple wallets in lega-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lega.cpp.
...
Changes to lega.cpp
----------------------
lega.cpp is the entry point into lega-qt, and as such, will require some minor modifications to provide hooks for
