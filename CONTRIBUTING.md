Contributing to Lega Core
==================================

The Lega Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Lega Core project, and is not to be
confused with overall Lega Network Protocol consensus changes.

Whether a pull request is merged into Lega Core rests with the project merge
...
Patches that change Lega consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lega consensus, it must have been
...
The project leader is the release manager for each Lega Core release.
